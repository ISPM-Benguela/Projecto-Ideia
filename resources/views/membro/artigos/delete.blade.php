    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                   <h2>Ver todos artigos <a href="{{route('artigo.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Voltar </a></h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <p>Tens certeza que desejas eliminar esta sugestão</p>

                    <form method="POST" action="{{ route('artigo.destroy', ['id' => $artigo->id]) }}">
